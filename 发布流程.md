   ...
   >cd /usr/local/nginx/
    ...
    ```vim
            ...
            location /springbootajax/ {
                    proxy_pass http://59.110.229.72:9090/springbootajax;
            }
    ```
    >启动nginx
    ...
    解决办法：
    ngin已开启或者根据Nginx配置文件查看配置的端口（本文中使用的是80端口），然后根据端口查看端口占用情况
...
3. 慎重地选择朋友——关系的力量
   注意：不要听贫穷的或是胆小的人的话。如果听了他们的话，你最终也会成为“小鸡式”的人。
   明智的投资者往往会购买一项不被大众看好的投资，他们懂得利润在购买时已经确定，而不是在售出时获得的，而不是在出售时获得的。他们并不计较市场时机，会耐心等待投资的增值。
4. 掌握一种模式，然后再学习一种新的模式——快速学习的力量
   你学到了什么，就会成为什么样的人。
   你学到的东西再多都不算多，因为当你学到的时候已经过时了。问题在于你学的有多快，这种技能是无价之宝。如果你想赚钱，寻找一条捷径是非常关键的。
5. 首先支付自己——自律的力量
   生活推着你转。
   现金流管理、人事管理、个人时间管理
   首先不能陷入债务中。当我偶尔资金短缺时，我仍会先支付自己，但我都会还清债务，不会陷入债务危机。